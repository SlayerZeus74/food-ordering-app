...
paymentForm.addEventListener('submit', (e)=>{
  ...
  document.getElementById('order-confirmed').innerHTML = `<div id="order-confirm" class="order-confirm">
    ...
    menuArray.forEach((item)=>{
        if(item.quantity > 0){
            ...
            cartHtml += `
                <div class="item">
                    <div class="details">
                        <h2 id = "cart-item-quantity" class="cart-item-quantity">(${item.quantity})</h2>
